...
export default function Dock({
  ...
  magnification: desktopMagnification = 55,
  distance = 80,
  baseItemSize: desktopBaseItemSize = 40
}: DockProps) {
  ...
  const dockClasses = "flex items-end gap-2 sm:gap-3 rounded-2xl bg-card/80 border border-border/20 backdrop-blur-md p-1.5 shadow-2xl";
