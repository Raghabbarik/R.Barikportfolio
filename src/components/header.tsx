...
const PillNav: React.FC<PillNavProps> = ({
  ...
  return (
    <div className="absolute top-[1em] z-[1000] w-full left-0 md:w-auto md:left-auto md:right-[1em]">
      <nav
      ...
      >
          ...
          >
            <div ref={logoImgRef} className="w-full h-full flex items-center justify-center text-background">
        ...
        >
          ...
          >
            {[...items, { label: 'Admin', href: '/admin' }].map((item, i) => {
      ...
      >
        <ul className="list-none m-0 p-[3px] flex flex-col gap-[3px]">
          {[...items, { label: 'Admin', href: '/admin' }].map(item => {
            ...
            const linkClasses =
              'block py-3 px-4 text-[16px] font-medium rounded-[24px] transition-all duration-200 ease-[cubic-bezier(0.25,0.1,0.25,1)] text-center';
